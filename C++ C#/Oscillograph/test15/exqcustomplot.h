...
public:
  ...
  */
  ...
  void EXrescale(bool onlyVisiblePlottables=false, int addPersent=10, bool extendToZero=false);//EX Anton Kushnir
...
public:
  ...
  */
  ...
  Q_SLOT void EXrescaleAxes(bool onlyVisiblePlottables=false, int addPersent=10,
                            bool extendToZero=false);//EX Anton Kushnir
...
signals:
  ...
  void mouseEnter(QEvent* event); //EX Anton Kushnir
  void mouseLeave(QEvent* event); //EX Anton Kushnir
...
protected:
  ...
  virtual void enterEvent(QEvent* event);//EX Anton Kushnir
  virtual void leaveEvent(QEvent* event);//EX Anton Kushnir
...
class QCP_LIB_DECL QCPAxisRect : public QCPLayoutElement
{
  ...
  //EX Anton Kushnir
//  Q_PROPERTY(bool isMaxRanges READ isMaxRanges WRITE setIsMaxRanges)
//  Q_PROPERTY(QCPRange HorizontMaxRange READ HorizontMaxRange WRITE setHorizontMaxRange)
//  Q_PROPERTY(QCPRange VertMaxRange READ VertMaxRange WRITE setVertMaxRange)
  /// \endcond
public:
  ...
  //EX Anton Kushnir
//  bool isMaxRanges() const {return mIsMaxRanges;}
//  QCPRange HorizontMaxRange() const {return mHorizontMaxRange;}
//  QCPRange VertMaxRange() const {return mVertMaxRange;}
  ...
  //EX Anton Kushnir
//  void setIsMaxRanges(bool is){mIsMaxRanges=is;}
//  void setHorizontMaxRange(const QCPRange &maxrange){mHorizontMaxRange=maxrange;}
//  void setVertMaxRange(const QCPRange &maxrange){mVertMaxRange=maxrange;}
  // non-property methods:
...
protected:
  ...
  //EX Anton Kushnir
//  bool mIsMaxRanges;
//  QCPRange mHorizontMaxRange;
//  QCPRange mVertMaxRange;
