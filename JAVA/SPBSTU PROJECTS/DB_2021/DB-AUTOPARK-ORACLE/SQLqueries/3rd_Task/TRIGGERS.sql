...
SELECT * FROM JOURNAL ORDER BY AUTO_ID;
...
SELECT * FROM JOURNAL JOIN ROUTES R on R.ID = JOURNAL.ROUTE_ID;

UPDATE ROUTES SET NAME = 'NewRoute №2' WHERE ID = 2;
...
DELETE FROM AUTO_PERSONNEL WHERE ID = 6;
